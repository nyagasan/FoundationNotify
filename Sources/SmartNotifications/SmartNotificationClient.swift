...
public struct SmartNotificationClient: Sendable {
    ...
    public func generate(_ request: SmartNotificationRequest) async throws -> NotificationDraft {
        do {
            ...
            throw SmartNotificationError.generationFailed(String(describing: error))
        }
    }
